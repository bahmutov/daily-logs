...
- scheduling Applitools webinar, probably April 24th @presentation
- trying to test online webinar for React Karlsruhe for tomorrow <https://www.meetup.com/react_ka/events/259387405/> @presentation
- confirmed Cypress presentation for May 15th at Boston .NET arhitecture meetup <https://www.meetup.com/Boston-NET-Architecture-Group/events/lxwmvqyzhbtb/> @presentation
...
- organized replacement speaker for iJC conference in London in May to talk about Cypress @presentation
...
- Think about Percy webinar, need slides by Friday @presentation
...
- started slide deck for Percy.io webinar, invited **redacted** from Percy to collaborate on it @presentation
...
- more work on finishing slides and cutting their number <https://slides.com/bahmutov/json-schemas-update> @presentation
...
- discussing webinar with Applitools @presentation
...
- [x] announcement for Applitools webinar @presentation
- [x] reply to ReactiveConf 2019 @presentation
...
- reply to ReactiveConf organizers @presentation
- proposal for Applitools @presentation
...
- working on slides for Percy webinar <https://slides.com/bahmutov/visual-testing-with-percy> @presentation

## Friday 2019-04-05

- marketing issue about GraphQL contributors online day @presentation
...
- more work on Percy.io slides @presentation
...
- Percy slides review @presentation
...
- updated Percy.io webinar slides @presentation
- applied to TestCon Europe 2019 @presentation
...
- meeting with ngx-bootstrap team about their experience using Cypress. They also are writing about Applitools <https://valor.webflow.io/articles/case-study-of-applitools-or-not-only-cypress-cross-browser-testing> They are great candidate for user case study @presentation
...
- more tweaking of Percy.io webinar slides @presentation
...
- final touches for webinar <https://slides.com/bahmutov/visual-testing-with-percy> @presentation
...
- marketing standup @internal
- AppVeyor webinar meeting with Gil @presentation
...
- Interview with ngVikings to promote upcoming Cypress workshop @presentation
...
- send Cypress logo to the Applitools team for the upcoming webinar @presentation
...
- wrote several tests for <https://github.com/applitools/cypress-applitools-webinar> @presentation
  - login
  - login using XHR
...
- day off
- wrote a few more functional tests for <https://github.com/applitools/cypress-applitools-webinar/issues/1> @presentation

## Thursday 2019-04-18

- use full spec filenames in testing workshop slides for clarity <https://github.com/cypress-io/testing-workshop-cypress/issues/64> @presentation
- small tweaks to Applitools webinar code @presentation
- started the slides for Applitools webinar https://slides.com/bahmutov/flawless-tests?token=QJztxl9Q @presentation
...
- more work on slides for Applitools @presentation
...
- more tests for the webinar @presentation
- update visual testing guide <https://github.com/cypress-io/cypress-documentation/pull/1536> @example

## Monday 2019-04-22

- more work on Applitools slides @presentation
- Applitools webinar sync @presentation
...
- slide for CircleCI Orb hackathon @presentation
...
- quick hello to a meetup in Brazil that is doing talk about Cypress @presentation
...
- Finish JSNation interview @presentation
...
- replied to <https://devopsstage.com/> @presentation
- replied to <https://revojs.ro/> @presentation
